...
<a href="?url=dash/sub" > <i class=" glyphicon glyphicon-arrow-left" ></i> retour a la liste des matieres</a>
      <!-- SELECT2 EXAMPLE -->
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input id='sub'  class="form-control select2" style="width: 100%;">
...
<!--          Visit <a href="https://select2.github.io/">Select2 documentation</a> for more examples and information about
      ...
      <div class="row">
        ...
        <div class="pull pull-right">
              ...
              <button  id='addsub' class="btn btn btn-primary" > ajouter une matiere </button> 
  ...
  <script src="../assets/js/control/subject_control.js"></script>