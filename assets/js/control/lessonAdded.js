 ...
 */
var url="../Models/datalist/lesson.php";
        ...
        $.getJSON("../Models/DataView/LessonAdded.php",function(donnees){
                  ...
                  $.each(donnees,function(i,donnees){
                   ...
                   $('#sub_dis').append("<tr>"
                        ...
                        +" <td><a href='' id=aff##"+donnees.LessonID+"><i  class=' text-primary glyphicon glyphicon-pencil'></i>modifier</a></td>"
    ...
    var recupID = $(this).attr('id');
      ...
      if(rep[0]==='aff'){
       ...
       $.get(url,{aff:'ed',added:rep[1]},function(up){
                ...
                window.location ="?url=lesson_add&tilte="+up.LessonTitle+"&lecon_added="+up.LessonField+"&numbrastic="+up.LessonID;
        ...
        $("#confirm-dial").dialog({
            ...
            "Confirmation": function() {
               ...
               $.get(url,{delete:'delete',numb:repn[1]},function(){
                     ...
                     //   alert(d.antille);
                     window.location = '?url=lesson/added';
